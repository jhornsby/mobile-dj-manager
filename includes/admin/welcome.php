			...
			<div class="changelog">
				...
				<div class="feature-section">
					...
					<div class="feature-section-content">
						...
						<p><?php printf( __( 'Create contract templates that be assigned to your %s. Clients will be able to review and <strong>Digitally Sign</strong> the contract via the %2$s.', 'mobile-dj-manager' ), mdjm_get_label_singular(), mdjm_get_app_name() ); ?></p>
					</div>
				</div>
			</div>
			...
			<div class="changelog">
				...
				<div class="feature-section two-col">
					...
					<div class="col">
						...
						<p><?php printf( __( 'Via the %s, clients are able to review and digitally sign their %s contract. Signing requires confirmation of their name and password for verification to maintain security.', 'mobile-dj-manager' ), mdjm_get_app_name(), mdjm_get_label_singular() );?></p>
					</div>
				</div>
                <div class="feature-section two-col">
					<div class="col">
